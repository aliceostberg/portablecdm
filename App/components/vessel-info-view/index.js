...
<<<<<<< HEAD
          {(!!extraInfo && !!extraInfo.width) &&
            <Text style={styles.infoText}><Text style={{fontWeight: 'bold'}}>Width: </Text>{extraInfo.width}m</Text>
=======
...
>>>>>>> a935a981ff25c3a3f84b14844362c253cec175af
          }
        </View>
      </View>
    );
